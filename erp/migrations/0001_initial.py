# Generated by Django 5.0.4 on 2024-05-20 07:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cattle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erp.cattle')),
                ('check_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erp.person')),
                ('data_encoded_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='erp.employee')),
            ],
            options={
